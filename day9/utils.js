...
const getParamValue = (param, paramMode, intCode, baseOffset=0) => {
    ...
    else if (paramMode == 2) return (intCode[param] + baseOffset) >= intCode.length ? 0 : intCode[intCode[param] + baseOffset];
}
    ...
    for (let i=0; i<intCode.length; i++) {
        ...
        switch(opcode) {
            case 1:
                ...
                intCode[getParamIndex(i+3, paramModes.third, intCode, baseOffset)] = getParamValue(i+1, paramModes.first, intCode, baseOffset) + getParamValue(i+2, paramModes.second, intCode, baseOffset);
                i+=3;
                continue;
            case 2:
                // Multiplication
            ...
            case 5:
                ...
                i = getParamValue(i+1, paramModes.first, intCode, baseOffset) != 0 ? getParamValue(i+2, paramModes.second, intCode, baseOffset) - 1 : i + 2;
            ...
            case 7:
                ...
                intCode[getParamIndex(i+3, paramModes.third, intCode, baseOffset)] = getParamValue(i+1, paramModes.first, intCode, baseOffset) < getParamValue(i+2, paramModes.second, intCode, baseOffset) ? 1 : 0;
