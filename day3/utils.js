...
const makePath = (dirs) => {
    ...
    for (let d of dirs) {
        ...
        switch(direction) {
            case 'U': path = path.concat(makePathUp(path[path.length - 1], distance)); break;
            case 'D': path = path.concat(makePathDown(path[path.length - 1], distance)); break;
            case 'R': path = path.concat(makePathRight(path[path.length - 1], distance)); break;
            case 'L': path = path.concat(makePathLeft(path[path.length - 1], distance)); break;
        }
